...
if (Thrift_VERSION MATCHES "^Thrift version")
  string(REGEX MATCH "[0-9]*[.][0-9]*[.][0-9]*$" VER ${Thrift_VERSION})
  if (Thrift_FIND_VERSION)
    if (${VER} VERSION_LESS ${Thrift_FIND_VERSION})
      message(FATAL_ERROR "Found thrift version ${VER} need minimum ${Thrift_FIND_VERSION}")
    endif()
  endif()
  if(NOT Thrift_FIND_QUIETLY)
