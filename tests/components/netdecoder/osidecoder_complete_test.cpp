...
class NetDecoderTest : public ::testing::Test {
  public:
    NetDecoderTest() {}
...
TEST_F(NetDecoderTest, decoder_treat_eth_nullptr_test) {
...
TEST_F(NetDecoderTest, decoder_treat_vlan_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_pppoe_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_mpls_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_ip_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_udp_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_tcp_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_gtp_nullptr_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_eth_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_vlan_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_pppoe_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_mpls_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_ip4_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_ip6_test) {
...
TEST_F(NetDecoderTest, decoder_treat_udp_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_tcp_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_gtp_test) {
    auto &decoder = this->getDecoder();
...
TEST_F(NetDecoderTest, decoder_treat_sctp_test) {
    auto &decoder = this->getDecoder();
